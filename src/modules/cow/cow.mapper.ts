...
export function bcsMapperToResponseDto(
  ...
  return new BodyConditionScoreResponseDto({
    ...
    score: bcs.score,
    modelScore: bcs.modelScore,
    scoreSource: bcs.scoreSource,
    overrideReason: bcs.overrideReason,
    overriddenAt: bcs.overriddenAt,
    overriddenByUserId: bcs.overriddenByUserId,
    appliedReviewId: bcs.appliedReviewId,
